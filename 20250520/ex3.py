...
async def find_bus_and_plot(route_id: str):
    ...
    # 讀取地理資料檔案，指定圖層
    file_path = r"C:\Users\User\Desktop\cycu_oop_11372011\20250520\鄉(鎮、市、區)界線1140318\TOWN_MOI_1140318.shp"
    ...
    filtered_gdf.plot(ax=ax, color="lightyellow", edgecolor="black")  # 灰色填充，黑色邊界
